...
public class OrderItem
{
    ...
    public string Details 
    {
        get
        {
            ...
            if (Toppings.Any())
            {
                // Remove the minus sign for toppings display
                ...
                parts.Add($"Topping: {string.Join(", ", toppingPrices)}");
            }
    ...
    public decimal GetPrice() 
    {
        ...
        // Apply size adjustment to the final price
        return StaticMenuData.CalculatePriceBySize(basePrice, Size);
    }
